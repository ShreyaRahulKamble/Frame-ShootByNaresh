...
const heroImages = [
  { src: '/assets/image1.png', alt: 'Interior photography showcase 1' },
  { src: '/assets/image2.png', alt: 'Interior photography showcase 2' },
  { src: '/assets/image3.png', alt: 'Interior photography showcase 3' },
];
